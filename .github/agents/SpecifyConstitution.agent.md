...
tools:
  ...
  - edit
---
<!-- layer: 2 | domain: Specify Constitution -->
...
- If the invocation context marks this agent as disabled or excluded, respond with one line: `SpecifyConstitution is disabled for this execution.`
